            ...
            <div className="col-md-8 col-lg-8 col-sm-12 col-xs-12">
              <div class="card">
                <div class="card-body shadow-lg">
                  ...
                  {!cart.length ? (
                    <p>No Products In Cart Yet <a href="/shop">Continue Shopping</a></p>
                  ) : showCartItems(cart)
                  }
                ...
                <div class="card-body">
                  ...
                  <div className="mb-2">
                    <InputGroup className="mb-3">
                      ...
                      <Form.Control aria-label="Dollar amount (with dot and two decimal places)" placeholder="Enter Coupon" />
              ...
              <div>
                ...
                <div className="card shadow-lg">
                  <div className="card-body">
                    ...
                    <Button variant="link" className="text-success"><FaWhatsapp size={26} /></Button>
                    <Button variant="link" className="text-dark"><FaEnvelope size={25} /></Button>
                  </div>
                </div>
